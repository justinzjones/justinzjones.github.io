...
import image0 from '@/images/photos/image-0.png'
...
function Newsletter() {
  return (
    <form
      action="/thank-you"
      className="hidden p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40"
    >
...
function Resume() {
  ...
  return (
    <div className="p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40">
      ...
      <Button href="#" variant="secondary" className="w-full mt-0 group">
        Download CV
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="flex justify-center gap-5 py-4 -my-4 overflow-hidden sm:gap-8">
        {[image2, image0, image7, image1  ].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          Technology professional specializing in travel systems, online commerce and payments.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Justin, I've worked in the travel technology space for a quarter of a century. 
            Things have changed a lot in that time and I can attest to the phenomenom of 'accelerating change'.
            I'm based in Dallas, Texas where I live with my wife, 2 boys and our cat.
          </p>
          <div className="flex gap-6 mt-6">
            ...
            /> */}
            <SocialLink
              href="https://github.com/u843867"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/justin-jones-93962419/"
      ...
      <Photos />
      <Container className="hidden mt-24 md:mt-28">
        <div className="grid max-w-xl grid-cols-1 mx-auto gap-y-20 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="space-y-0 lg:pl-16 xl:pl-24">
            <Newsletter />
            <Resume />
          </div>
        </div>
